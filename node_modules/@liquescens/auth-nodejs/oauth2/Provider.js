...
export class Provider
{
    ...
    //  * @returns {Promise<UserInfo & { raw_info: string }>}
    //  */
    // async authenticate(authorization_code)
    // {
    //     if (typeof authorization_code !== 'string') throw new AuthenticationException('authorization_code', 'TODO');
    ...
    //     const userinfo_response = await this._fetchUserInfo(access_token);
    //     const data = await this._parseUserInfo(userinfo_response);
    //     return data;
    // }
    ...
    {
        if (typeof access_token !== 'string') throw new AuthenticationException('token', 'TODO');
